In this chapter, we recall briefly basic definitions and properties, as well as more unusual results, needed throughout the thesis. Rather than an introduction to each of those topics, one should see this chapter as a toolbox and use it when needed in the other chapters.
