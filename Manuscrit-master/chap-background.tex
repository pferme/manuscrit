P NP classes?
Hardness reductions?
General probability theory? NO: only technical stuff and recall the distributions
...
\newpage
\section{Probability}
\subsection{Usual Distributions}
TODO
...
\[\forall x \in \mathcal{X},\forall y \in \mathcal{Y},\forall z \in \mathcal{Z}, \mathbb{P}\left(Z=z|Y=y,X=x) = \mathbb{P}\left(Z=z|Y=y) \ .\]
\end{definition}
