In this chapter, we recall briefly definitions and properties as well as more unusual results needed throughout the thesis. Therefore, this should be considered as a toolbox as one encounters the presented notions in the next chapters rather than an introduction to each of the mentioned topics.
