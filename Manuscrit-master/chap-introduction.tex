...
%\newpage
%Entanglement, EPR paradox, Bell, CHSH, Aspect
%Superdensecoding, no QE ptp capacity advantage
...
%Explain, theoritical but useful, example of the CHSH game where it is stronger than quantum.
...
%In this thesis, address the problem of finding efficient codes for several communication scenarios. Problem studied for network scenarios of MACs, Broadcast channels, as well as their link to their NS capacities.
