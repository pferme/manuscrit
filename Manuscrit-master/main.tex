...
%\addcontentsline{tof}{chapter}{Résumé substantiel en français}
...
\chapter*{Introduction}
\label{chap:introduction-fr}
\addcontentsline{tof}{chapter}{\protect\numberline{\thechapter} Introduction}

\input chap-introduction-fr

\cleardoublepage
{\let\newpage\relax
\chapter{Background}
\addcontentsline{tof}{chapter}{\protect\numberline{\thechapter} Préliminaires}
...
\addcontentsline{tof}{chapter}{\protect\numberline{\thechapter} Strictes garanties d'approximation pour des problèmes de couverture concaves}
...
\addcontentsline{tof}{chapter}{\protect\numberline{\thechapter} Problème du codage pour les canaux à accès multiple et corrélations non-signalantes}
\label{chap:MAC}
}
...
\addcontentsline{tof}{chapter}{\protect\numberline{\thechapter} Problème du codage pour les canaux de diffusion et corrélations non-signalantes}
...
\chapter*{Conclusion}
\label{chap:conclusion-fr}
\addcontentsline{tof}{chapter}{\protect\numberline{\thechapter} Conclusion}

\input chap-conclusion-fr
