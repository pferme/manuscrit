...
\begin{figure}[!h]
    \begin{center}
      \begin{tikzpicture}
        ...
        \legend{$\mathcal{C}(W_{\text{BAC},\varepsilon,\varepsilon})$ for $\varepsilon = 10^{-3}$, ZE NS Capacity Region, NS Achievable Points for $3$ copies, NS Achievable Points for $5$ copies}
