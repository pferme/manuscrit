...
\begin{frame}{The NS advantage hardness equivalence}
  \begin{itemize}
  \item Global sum up (higher level)
  \item Critical link complexity hardness and non-signaling advantage \cite{JNVWY20}
    \bigskip
  \item THE END
  \end{itemize}
\end{frame}
