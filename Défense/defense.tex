  ...
  \item Comprendre physique à l'\emph{échelle} des atomes -- \emph{un million de fois plus petit qu'un grain de sable !} (0,1nm)
    \begin{center}
      \begin{tikzpicture}
        ...
        \only<3-4>{\draw[snake=coil, dotted, thick, red] (0,0) -- (3,0);}
      \end{tikzpicture}
    \end{center}
    \pause
...
\begin{frame}{Le paradoxe Einstein-Podolski-Rosen}
  ...
  \item Communication plus rapide que la lumière ? \pause{\alert{\emph{Corrélations !}}}
  \end{itemize}
\end{frame}
...
\begin{frame}{Le jeu CHSH 1}
  TODO
\end{frame}

\begin{frame}{Le jeu CHSH 2}
  TODO
\end{frame}
