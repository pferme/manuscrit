...
This section shows that instantiations of $\varphi$-\textsc{MaxCoverage} encapsulate and generalize multiple problems from fields such as computational social choice \cite{BCE16} and algorithmic game theory \cite{NRTV07}.
