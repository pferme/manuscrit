...
\begin{equation}
  \begin{aligned}
    ...
    \Big(\text{resp. }\mathrm{S}_{\text{sum}}^{\mathrm{NS}_{\text{dec}}}(W,k_1,k_2) := &&\underset{e,d_1,d_2}{\maxi} &&& \frac{1}{k_1k_2}\sum_{i_1,i_2,x,y_1,y_2} W(y_1y_2|x)e(x|i_1i_2)\frac{\sum_{j_2}d(i_1j_2|y_1y_2) + \sum_{j_1}d(j_1i_2|y_1y_2)}{2}\Big)\\
